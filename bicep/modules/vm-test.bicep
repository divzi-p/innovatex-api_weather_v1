...
param vmName string = 'vm-test-performance'
...
param dnsLabelPrefix string = toLower(concat(vmName,'-${uniqueString(resourceGroup().id)}'))
...
var subnetRef = '${computeVnet.id}/subnets/${subnetName}'
